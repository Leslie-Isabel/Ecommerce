...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email'=>'required|string|max:255|email:rfc,dns|unique:providers,email,'. $this->route('provider')->id,
            'document'=>'required|string|max:10|min:10|unique:providers,document,'. $this->route('provider')->id,
            'address'=>'nullable|string|max:255',
            'phone'=>'required|string|max:10|min:8|unique:providers,phone,'.$this->route('provider')->id,
        ];
    }
    ...
    public function messages()
    {
        return[
            ...
            'document.min'=>'El campo cédula debe contener almenos 10 caracteres.',
            ...
            'phone.string'=>'El campo telefono solo debe contener letras.',
            'phone.max'=>'El campo telefono solo permite 10 caracteres.',
            'phone.min'=>'El campo telefono debe contener almenos 8 caracteres.',
            'phone.unique'=>'El campo telefono ya esta en uso.',
