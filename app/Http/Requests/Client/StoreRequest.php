...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email'=>'required|string|max:200|email:rfc,dns|unique:clients',
            'document'=>'required|string|max:10|min:10|unique:clients',
            'address'=>'nullable|string|max:255',
            'phone'=>'required|string|max:10|min:8|unique:clients'
        ];
    }
    ...
    public function messages()
    {
        return[
            ...
            'phone.required'=>'El campo cédula es requerido.',
            'phone.string'=>'El campo cédula solo debe contener letras.',
            'phone.max'=>'El campo cédula solo permite 10 caracteres.',
            'phone.min'=>'El campo cédula debe contener almenos 8 caracteres.',
            'phone.unique'=>'El campo cédula ya esta en uso.',
