...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'document'=>'required|string|max:10|min:10|unique:clients,document,'. $this->route('client')->id,
            'address'=>'nullable|string|max:255',
            'phone'=>'required|string|max:10|min:8|unique:clients,phone,'.$this->route('client')->id,
        ];
    }
